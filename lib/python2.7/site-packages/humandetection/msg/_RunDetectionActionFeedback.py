...
"""autogenerated by genpy from humandetection/RunDetectionActionFeedback.msg. Do not edit."""
import sys
...
class RunDetectionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "humandetection/RunDetectionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','humandetection/RunDetectionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunDetectionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = humandetection.msg.RunDetectionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = humandetection.msg.RunDetectionFeedback()
