...
"""autogenerated by genpy from humandetection/ChangeClassifierAction.msg. Do not edit."""
import sys
...
class ChangeClassifierAction(genpy.Message):
  _md5sum = "854ff41f30b2a3f67fd6cf7d6bd35193"
  _type = "humandetection/ChangeClassifierAction"
...
"""
  ...
  _slot_types = ['humandetection/ChangeClassifierActionGoal','humandetection/ChangeClassifierActionResult','humandetection/ChangeClassifierActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ChangeClassifierAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = humandetection.msg.ChangeClassifierActionGoal()
      if self.action_result is None:
        self.action_result = humandetection.msg.ChangeClassifierActionResult()
      if self.action_feedback is None:
        self.action_feedback = humandetection.msg.ChangeClassifierActionFeedback()
    else:
      self.action_goal = humandetection.msg.ChangeClassifierActionGoal()
      self.action_result = humandetection.msg.ChangeClassifierActionResult()
      self.action_feedback = humandetection.msg.ChangeClassifierActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_H3I.pack(_x.action_goal.goal.classifier, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.classifier, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_H3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
